...
See also: `nortropic-antislop`, `nortropic-prelaunch` — motion-craft review of the built result belongs to `design-reviewer`'s canon, `emil-design-eng` (easing/physics taste — animation decisions per Emil Kowalski's philosophy).
