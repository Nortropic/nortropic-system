...
#if defined(H039_INSTALLER) && (!defined(H039_MEDIATOR_SHA256) || !defined(H039_MEDIATOR_SIZE) || !defined(H039_ROOT_ENTRY_FD0_NORMALIZATION) || !defined(H039_OLD_MEDIATOR_SHA256) || !defined(H039_OLD_MEDIATOR_SIZE))
