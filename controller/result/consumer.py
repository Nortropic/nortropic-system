...
def consume_private_result(sink_fd, canonical_destination, invocation_id, run_id, role):
    ...
    try:
        ...
        try:
            ...
            os.close(temp_fd)
            temp_fd = -1
        os.replace(temp_name, canonical_destination)
        temp_name = None
        return envelope
    finally:
        try:
