...
const FORVANTAD_KALLHASH = '9d67626710353c8c'
...
const UTAN_ANROPARE = {
  ...
  'scripts/publicera.sh': 'ÄR prövad — tests/scripts/publicera/fall.sh kör den i 29 fall med stubbade gh och claude, och fjorton mutationer (merge-villkoren, repo-utvinningen, kvitto, ci-filter, granskarmiljön) fälls. Körs av kedjedrivaren vid varje avslutad leverans (AGENTS.md "Före varje merge"); samma blindfläck som autocommit-raden: vaktens körarmängd når inget prov under tests/ (2026-09-17, L1b)',
