...
CURRENT_RESULT=the R10 implementation derives the task gate's exact regular Git blob and digest from the candidate object through all four consumers; the frozen gate reports 216 PASS, 0 FAIL
