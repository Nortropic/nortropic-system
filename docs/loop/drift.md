...
## H-035 R31 — request-bound registry consumer boundary
...
H039-member broad-task control. R29's two product
...
The first drift is Git framing: newline/text output is not an exact path transport. R31 requires
...
exact import plus request-bound core/CLI islands is AST-exact to that base.

R31 grants no registry mutation, broad prefix or new owner authority. The six TEST_AUTHOR and two
