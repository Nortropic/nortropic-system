...
## H-035 R32 — request-bound registry consumer boundary
...
The first drift is Git framing: newline/text output is not an exact path transport. R32 requires
...
R32 grants no registry mutation, broad prefix or new owner authority. The six TEST_AUTHOR and two
