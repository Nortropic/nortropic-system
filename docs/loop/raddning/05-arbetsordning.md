...
| **Grinden har frysts om mer än 3 gånger** | **Mätt diskriminant:** varje klar task har en grind rörd ≤ 3 gånger; varje icke-klar 17–147. Ingen mellanform | Budgeten är slut. Dela hypotesen eller avsluta den `OVERIFIERAT`. **Aldrig en runda till** — se `03-raddningsplan.md` steg 1b iv |
