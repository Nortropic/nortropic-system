...
4. Per-page copy rules:
   ...
   - Ton per briefens §7-register (adjektiv + exempelmeningar + vernacular); branschspecifika tonmönster bor i paketets strategimodul (`packs/<paket>/strategi/`), aldrig här
