# FOUNDATION SMOKE FIXTURE — klippt (§A6)

**STATUS: KLIPPT 2026-08-25.** Klippet utfördes som ägarstyrd MÄNSKLIG HÖGRISK-handling enligt
ceremonin nedan (bas `96d9d733`): testklienten skapad, kanonisk axe PASS (noll violations),
kanonisk Lighthouse `FOUNDATION_LIGHTHOUSE_EXPECTED_NOINDEX_RED` (steg 5, samtliga 13 villkor)
med dokumenterad kausalkontroll (samma sida minus enbart noindex ⇒ PASS), mall-linssmoke
genomförd. FOUNDATION_REPAIR_GATE värderas fortfarande ENDAST av en OBEROENDE granskning efter
ägarens publicering (steg 10) — klippsessionen självcertifierar aldrig gaten.
...
| 7 | Bygg-/granskningsmaskineri fungerar på liten fabricerad TESTKLIENT utan desktop-beroenden | KLIPPT (2026-08-25): `foundation/testklient/index.html` finns — en MINIMAL fabricerad-märkt sida (statisk, en sida, FABRICERAD-banner, noindex) som ger verktygskedjan (axe + Lighthouse + template-lins-läsning) ett verkligt mål; noindex är en SÄKERHETSEGENSKAP och gör per design Lighthouse-SEO avsiktligt rött — klippets bevisade utfall är axe PASS (noll violations) + FOUNDATION_LIGHTHOUSE_EXPECTED_NOINDEX_RED (steg 5; 100/100/96/60, enda avvikelse `seo: 60.0 < 95`, kausalkontroll PASS 100/100/96/100); INTE en kundsajt, INTE rorjour-formad, inga §7-anspråk | KLIPPT 2026-08-25 |
